...
--
-- Host: localhost
-- Generation Time: Jan 09, 2016 at 05:53 PM
...
INSERT INTO `users` (`userid`, `first_name`, `last_name`, `profile_picture`, `mobile`, `email_address`, `username`, `password`, `city`, `account_type`, `state`, `country`, `pincode`, `address`, `industry_id`, `business_id`, `status`, `created_on`, `updated_on`) VALUES
