...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2016 at 06:50 AM
...
CREATE TABLE `customer_contact_details` (
  `contact_detail_id` int(20) NOT NULL,
  `professional_user_id` int(20) NOT NULL,
...
--
-- Table structure for table `prof_user_business_details`
--

CREATE TABLE `prof_user_business_details` (
  `prod_user_business_detail_id` int(20) NOT NULL,
  `userid` int(20) NOT NULL,
  `user_profile_picture` varchar(150) NOT NULL,
  `about_us` text NOT NULL,
  `business_pictures` text NOT NULL,
  `business_logo` varchar(150) NOT NULL,
  `operating_hours` text NOT NULL,
  `facebook_page` varchar(150) NOT NULL,
  `twitter_page` varchar(150) NOT NULL,
  `google_plus_page` varchar(150) NOT NULL,
  `awards` text NOT NULL,
  `added_date_on` datetime NOT NULL,
  `updated_on` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `promotional_offers` (
  `promotional_offer_id` int(20) NOT NULL,
  `user_id` int(20) NOT NULL,
  `promotian_title` varchar(200) NOT NULL,
  `promotial_pictures` text NOT NULL,
  `promotional_details` text NOT NULL,
  `promotion_period` varchar(150) NOT NULL,
  `term_conditions` text NOT NULL,
  `added_on` datetime NOT NULL,
  `updated_on` datetime NOT NULL,
  `status` int(5) NOT NULL COMMENT '0=>not show front end,1=>Show Front End,2=>Hide By Admin,3=>Deleted'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `promotional_offers` (`promotional_offer_id`, `user_id`, `promotian_title`, `promotial_pictures`, `promotional_details`, `promotion_period`, `term_conditions`, `added_on`, `updated_on`, `status`) VALUES
(1, 0, 'D', '1262433568_Tulips.jpg', 'dsfgdsf\r\nsdfds\r\nfdf\r\nfdf\r\ndf\r\ndfd\r\nfd\r\ngfhfgjgffffffffffffffffffffffff', 'Mon - Sat 10:00 Am to 7:00 PM', 'dsgdfsgdsg', '2008-02-16 02:52:10', '2008-02-16 02:52:10', 1),
(2, 0, 'Wedding Promotional Packages 2015', '856973322_Tulips.jpg', '1 Day Event Solemnization / Engagement / Pre-wedding / Post-wedding Magazine 20 pages Artcard A4 Paper DVD Copy with hard casing (Unlimited Photos)', '01 January 2015 - 31 December 2015', 'Valid in Johor Bahru Only. Other location will be extra charges. (Transport & Accommodation) 3 Hours Coverage. Extra charges for extra coverage. 1 Photographer.', '2008-02-16 02:57:54', '2008-02-16 02:57:54', 1),
(3, 0, 'Wedding Promotional Packages 2015', '1432297166_no-stress.jpg', '1 Day Event Solemnization / Engagement / Pre-wedding / Post-wedding Magazine 20 pages Artcard A4 Paper DVD Copy with hard casing (Unlimited Photos)', '01 January 2015 - 31 December 2015', 'Valid in Johor Bahru Only. Other location will be extra charges. (Transport & Accommodation) 3 Hours Coverage. Extra charges for extra coverage. 1 Photographer.', '2008-02-16 03:00:34', '2008-02-16 03:00:34', 1),
(4, 0, 'Wedding Promotional Packages 2015', '1769225242_no-stress.jpg', '1 Day Event Solemnization / Engagement / Pre-wedding / Post-wedding Magazine 20 pages Artcard A4 Paper DVD Copy with hard casing (Unlimited Photos)', '01 January 2015 - 31 December 2015', 'Valid in Johor Bahru Only. Other location will be extra charges. (Transport & Accommodation) 3 Hours Coverage. Extra charges for extra coverage. 1 Photographer.', '2008-02-16 03:13:01', '2008-02-16 03:13:01', 1),
(5, 0, 'Wedding Promotional Packages 2015', '1690358365_no-stress.jpg', '1 Day Event Solemnization / Engagement / Pre-wedding / Post-wedding Magazine 20 pages Artcard A4 Paper DVD Copy with hard casing (Unlimited Photos)', '01 January 2015 - 31 December 2015', 'Valid in Johor Bahru Only. Other location will be extra charges. (Transport & Accommodation) 3 Hours Coverage. Extra charges for extra coverage. 1 Photographer.', '2008-02-16 03:14:00', '2008-02-16 03:14:00', 1);
...
CREATE TABLE `reviews` (
  ...
  `professioanl_user_id` int(20) NOT NULL,
  `coustomer_id` int(20) NOT NULL,
  `rating_level` int(20) NOT NULL,
  `message` text NOT NULL,
  `created_on` datetime NOT NULL,
  `updated_on` datetime NOT NULL,
  `status` int(11) NOT NULL COMMENT '0=>Hide 1=>Show 2=>Pending'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `users` (
  ...
  `role` tinyint(2) NOT NULL COMMENT '1=>''normal_coustomer'',2=>''Business_coustomer''',
...
INSERT INTO `users` (`userid`, `first_name`, `last_name`, `profile_picture`, `mobile`, `email_address`, `business_email`, `username`, `company_name`, `password`, `city`, `account_type`, `state`, `country`, `pincode`, `address`, `industry_id`, `business_id`, `company_website`, `status`, `role`, `created_on`, `updated_on`) VALUES
(1, 'Arvind', 'kumar', '', '9457371618', 'arvind.kumar@onsumaye.com', '', 'arvind.kumar', '', 'e10adc3949ba59abbe56e057f20f883e', '106', 'dream_home', 'Arunachal Pradesh', '', '201301', 'test', 1, 2, '', 1, 0, '2015-12-12 05:10:47', '2015-12-15 17:07:01'),
(3, 'Arvind', 'Kumar', '', '9457371612', 'admin@gmail.com', '', 'test1234', '', '', '401', 'dream_home', 'Jammu and Kashmir', 'India', '201301', 'test2', 13, 148, '', 0, 0, '2015-12-14 11:20:27', '2015-12-15 17:15:18'),
(4, 'Arvind', 'Kumar', '', '9457371632', 'admin@gmail.comd', '', 'admin43', '', '', 'Noida', 'dream_home', 'Up', 'India', '201301', 'test', 2, 11, '', 0, 0, '2015-12-14 11:26:20', '2015-12-14 16:56:20'),
(5, 'ARVIND', 'kumar', '', '9457371618', 'arvind124gangwar@gmail.com', NULL, 'admindfhfgh', 'fgfg', 'admin@123', 'Assam', 'dream_home', 'Arunachal Pradesh', '', '91541454', 'fhfhf', 2, 0, 'www.hh.cc', 0, 0, '2016-01-10 16:42:11', '0000-00-00 00:00:00'),
(6, 'Anita', 'Gangwar', '', '8826501243', 'arvindd124gangwar@gmail.com', 'este@dfdf.comg', 'admindsfgdg', 'Intel', 'admin@123', 'Uttar Pradesh', 'dream_home', 'Uttar Pradesh', '', '262201', 'Noida sec 22', 4, 0, 'www.mybusinessplan.com', 0, 0, '2016-01-10 16:49:05', '0000-00-00 00:00:00'),
(7, 'Tarun', 'Mishra', '', '7458745457', 'tarun@gmail.com', 'ted@dgfg.com', 'tarun1234', 'My TtesttetetetComapny', '123456', 'Madgaon', 'dream_home', 'Goa', '', '201301', 'testdfdhi', 4, 0, 'fgfgfgfg', 0, 0, '2016-01-25 03:07:41', '0000-00-00 00:00:00'),
(8, 'Test', 'test', '', '5435465666', 'test1234@gfdg.com', 'teddfd@dgfg.com', 'anita1234', 'My test Comapny', '123456', 'Ashoknagar Kalyangarh', 'dream_home', 'West Bengal', '', '201301', 'fdsfdsfd', 4, 0, 'fgfgfgfg', 0, 0, '2016-01-26 18:34:14', '0000-00-00 00:00:00'),
(9, 'Arvind', 'Gangwar', '1295274547_Hydrangeas.jpg', '5812361465', 'anitaxx@gmail.com', NULL, '', '', 'bmd+QaRgU72iC9/HXfuBvrYT7RCWXhhfXwn9cQgHOKI=', '', 'dream_home', '', '', '', '', 0, 0, '', 1, 1, '2007-02-16 12:54:38', '2007-02-16 04:54:38'),
(10, 'Arvind', 'Gangwar', '1883416942_', '5812361465', 'anitaxxtrt55@gmail.com', NULL, '', '', 'bmd+QaRgU72iC9/HXfuBvrYT7RCWXhhfXwn9cQgHOKI=', '', 'dream_home', '', '', '', '', 0, 0, '', 1, 1, '2007-02-16 12:57:22', '2007-02-16 04:57:22'),
(11, 'Arvind', 'Gangwar', '385025314_', '5812361465', 'fgfgx@gmail.com', NULL, '', '', 'bmd+QaRgU72iC9/HXfuBvrYT7RCWXhhfXwn9cQgHOKI=', '', 'dream_home', '', '', '', '', 0, 0, '', 1, 1, '2007-02-16 13:02:25', '2007-02-16 05:02:25'),
(12, 'Arvind', 'Gangwar', '', '5812361465', 'anitgdfgdfaxx@gmail.com', NULL, '', '', 'bmd+QaRgU72iC9/HXfuBvrYT7RCWXhhfXwn9cQgHOKI=', '', 'dream_home', '', '', '', '', 0, 0, '', 1, 1, '2007-02-16 13:09:43', '2007-02-16 05:09:43'),
(13, 'Arvind', 'Gangwar', '374511204_Jellyfish.jpg', '5812361465', 'anfgdgitaxx@gmail.com', NULL, '', '', 'bmd+QaRgU72iC9/HXfuBvrYT7RCWXhhfXwn9cQgHOKI=', '', 'dream_home', '', '', '', '', 0, 0, '', 1, 1, '2007-02-16 13:10:12', '2007-02-16 05:10:12');
...
--
-- Indexes for table `prof_user_business_details`
--
ALTER TABLE `prof_user_business_details`
  ADD PRIMARY KEY (`prod_user_business_detail_id`);

--
-- Indexes for table `promotional_offers`
--
ALTER TABLE `promotional_offers`
  ADD PRIMARY KEY (`promotional_offer_id`);
...
--
-- AUTO_INCREMENT for table `prof_user_business_details`
--
ALTER TABLE `prof_user_business_details`
  MODIFY `prod_user_business_detail_id` int(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `promotional_offers`
--
ALTER TABLE `promotional_offers`
  MODIFY `promotional_offer_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
