...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2016 at 05:52 PM
...
CREATE TABLE IF NOT EXISTS `check_email_notifications` (
...
CREATE TABLE IF NOT EXISTS `facebook_share_image` (
...
INSERT INTO `users` (`userid`, `first_name`, `last_name`, `profile_picture`, `mobile`, `email_address`, `business_email`, `username`, `company_name`, `password`, `city`, `account_type`, `state`, `country`, `pincode`, `address`, `industry_id`, `business_id`, `company_website`, `status`, `created_on`, `updated_on`) VALUES
(1, 'Arvind', 'kumar', '', '9457371618', 'arvind.kumar@onsumaye.com', '', 'arvind.kumar', '', 'e10adc3949ba59abbe56e057f20f883e', '106', 'dream_home', 'Arunachal Pradesh', '', '201301', 'test', 1, 2, '', 1, '2015-12-12 05:10:47', '2015-12-15 17:07:01'),
(3, 'Arvind', 'Kumar', '', '9457371612', 'admin@gmail.com', '', 'test1234', '', '', '401', 'dream_home', 'Jammu and Kashmir', 'India', '201301', 'test2', 13, 148, '', 0, '2015-12-14 11:20:27', '2015-12-15 17:15:18'),
(4, 'Arvind', 'Kumar', '', '9457371632', 'admin@gmail.comd', '', 'admin43', '', '', 'Noida', 'dream_home', 'Up', 'India', '201301', 'test', 2, 11, '', 0, '2015-12-14 11:26:20', '2015-12-14 16:56:20'),
(5, 'ARVIND', 'kumar', '', '9457371618', 'arvind124gangwar@gmail.com', NULL, 'admindfhfgh', 'fgfg', 'admin@123', 'Assam', 'dream_home', 'Arunachal Pradesh', '', '91541454', 'fhfhf', 2, 0, 'www.hh.cc', 0, '2016-01-10 16:42:11', '0000-00-00 00:00:00'),
(6, 'Anita', 'Gangwar', '', '8826501243', 'arvindd124gangwar@gmail.com', 'este@dfdf.comg', 'admindsfgdg', 'Intel', 'admin@123', 'Uttar Pradesh', 'dream_home', 'Uttar Pradesh', '', '262201', 'Noida sec 22', 4, 0, 'www.mybusinessplan.com', 0, '2016-01-10 16:49:05', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `zerofill_tests` (
  `id` int(11) NOT NULL,
