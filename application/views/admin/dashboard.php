 <div class="graphs">
		       ...
		       <div class="activity_box">
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?php echo base_url();?>administrator/images/5.png' class="img-responsive" alt=""/></div>
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?php echo base_url();?>administrator/images/3.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?php echo base_url();?>administrator/images/1.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='<?php echo base_url();?>administrator/images/4.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			<link rel="stylesheet" href="<?php echo base_url();?>administrator/css/clndr.css" type="text/css" />
			<script src="<?php echo base_url();?>administrator/js/underscore-min.js" type="text/javascript"></script>
			<script src= "<?php echo base_url();?>administrator/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="<?php echo base_url();?>administrator/js/clndr.js" type="text/javascript"></script>
			<script src="<?php echo base_url();?>administrator/js/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="<?php echo base_url();?>administrator/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="<?php echo base_url();?>administrator/js/jquery.vmap.js"></script>
<script src="<?php echo base_url();?>administrator/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>administrator/js/jquery.vmap.world.js" type="text/javascript"></script>
